...
function getFoodCategories(foods) {
  const foodStatus = foods.map(function(recipe) {
    return recipe.isVegetarian == true ? recipe.food + ' is suitable for vegetarians' : recipe.food + ' is not suitable for vegetarians'
  });
  return foodStatus
}
